 ...
 */
public class RadioGridGroup extends FlexboxLayout implements View.OnClickListener{
    ...
    public void addView(View child, android.view.ViewGroup.LayoutParams params) {
        ...
        setChildrenOnClickListener((FlexboxLayout) child);
    }


    private void setChildrenOnClickListener(FlexboxLayout tr) {
