...
public class ProjectSpecificationTwoList implements Parcelable
{
    ...
    public final static Creator<ProjectSpecificationTwoList> CREATOR = new Creator<ProjectSpecificationTwoList>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ProjectSpecificationTwoList createFromParcel(Parcel in) {
            return new ProjectSpecificationTwoList(in);
        }

        public ProjectSpecificationTwoList[] newArray(int size) {
            return (new ProjectSpecificationTwoList[size]);
        }

    }
    ;

    protected ProjectSpecificationTwoList(Parcel in) {
        ...
        this.detailNote = ((String) in.readValue((String.class.getClassLoader())));
    ...
    public ProjectSpecificationTwoList() {
    }
