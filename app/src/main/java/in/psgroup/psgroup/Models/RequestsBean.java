...
public class RequestsBean implements Parcelable{
    String sk_category_id,category_name,support_type,category_status;

    public RequestsBean(String sk_category_id, String category_name, String support_type, String category_status) {
    ...
    protected RequestsBean(Parcel in) {
    ...
    public static final Creator<RequestsBean> CREATOR = new Creator<RequestsBean>() {
        @Override
        public RequestsBean createFromParcel(Parcel in) {
            return new RequestsBean(in);
        }

        @Override
        public RequestsBean[] newArray(int size) {
            return new RequestsBean[size];
        }
    };
