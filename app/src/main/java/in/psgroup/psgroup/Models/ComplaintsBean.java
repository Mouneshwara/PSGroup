...
public class ComplaintsBean implements Parcelable{
    ...
    public ComplaintsBean(String sk_category_id, String category_name, String support_type, String category_status) {
    ...
    protected ComplaintsBean(Parcel in) {
    ...
    public static final Creator<ComplaintsBean> CREATOR = new Creator<ComplaintsBean>() {
        @Override
        public ComplaintsBean createFromParcel(Parcel in) {
            return new ComplaintsBean(in);
        }

        @Override
        public ComplaintsBean[] newArray(int size) {
            return new ComplaintsBean[size];
        }
    };
