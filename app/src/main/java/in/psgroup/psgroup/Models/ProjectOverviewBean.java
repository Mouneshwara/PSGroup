...
/**
 * Created by Codebele on 11-Feb-19.
 */
public class ProjectOverviewBean implements Parcelable {
    String sk_details_id,post_id,detail_type,detail_title,detail_name,detail_desc,detail_date,last_tran_date,detail_status;

    public ProjectOverviewBean(String sk_details_id, String post_id, String detail_type, String detail_title, String detail_name, String detail_desc, String detail_date, String last_tran_date, String detail_status) {
    ...
    protected ProjectOverviewBean(Parcel in) {
    ...
    public static final Creator<ProjectOverviewBean> CREATOR = new Creator<ProjectOverviewBean>() {
        @Override
        public ProjectOverviewBean createFromParcel(Parcel in) {
            return new ProjectOverviewBean(in);
        }

        @Override
        public ProjectOverviewBean[] newArray(int size) {
            return new ProjectOverviewBean[size];
        }
    };
