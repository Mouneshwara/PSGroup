...
public class CheckPointHistoryLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = CheckPointHistoryLoader.class.getName();
    ...
    public CheckPointHistoryLoader(Context context, String access_token,HashMap<String, String> input) {
        super(context);
    ...
    private String makeHttpRequest() throws IOException, JSONException {
        ...
        Request request = new Request.Builder()
                .url(APIUrls.CHECK_POINT_HISTORY_API)
