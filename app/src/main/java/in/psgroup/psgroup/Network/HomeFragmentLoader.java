...
/**
 * Created by Codebele on 07-Feb-19.
 */
...
public class HomeFragmentLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = HomeFragmentLoader.class.getName();
    ...
    public HomeFragmentLoader(Context context, String access_token, HashMap<String, String>  input) {
        super(context);
        ...
        if (!TextUtils.isEmpty(jsonResponse)) {
            try {
                ...
                if (responsecode != 200) {
                  ...
                  /*  response.put("myproperties", jsonObject.getJSONArray("myproperties").toString());
                    response.put("offers", jsonObject.getJSONArray("offers").toString());
                    response.put("blog", jsonObject.getJSONArray("blog").toString());
                    response.put("events", jsonObject.getJSONArray("events").toString());
                    response.put("newlaunch",jsonObject.getJSONArray("newlaunch").toString());*/
