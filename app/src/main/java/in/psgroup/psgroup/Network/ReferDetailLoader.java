...
public class ReferDetailLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = ReferDetailLoader.class.getName();
    ...
    public ReferDetailLoader(Context context, String AccessToken, HashMap<String, String> input) {
        super(context);
