...
public class ResetPasswordLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public ResetPasswordLoader(Context context, HashMap<String, String> input) {
        super(context);
...
//        HashMap<String,String> query_explain=new HashMap<String,String>();
    ...
    private String makeHttpRequest() throws IOException, JSONException {
        ...
        Request request = new Request.Builder()
                .url(APIUrls.RESETPASSWORD_OTP_API)
