...
/**
 * Created by Codebele on 04-Feb-19.
 */
...
public class SignUpDetailsLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public SignUpDetailsLoader(Context context, HashMap<String, String> input) {
        super(context);
