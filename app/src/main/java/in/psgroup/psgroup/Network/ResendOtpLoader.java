...
public class ResendOtpLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public ResendOtpLoader(Context context, HashMap<String, String> input) {
        super(context);
