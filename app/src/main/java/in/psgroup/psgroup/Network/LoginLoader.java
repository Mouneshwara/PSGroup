...
public class LoginLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = LoginLoader.class.getName();
    ...
    public LoginLoader(Context context, HashMap<String, String> input) {
        super(context);
