...
public class EditProfileLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = EditProfileLoader.class.getName();
    ...
    public EditProfileLoader(Context context, String AccessToken, HashMap<String, String> input) {
        super(context);
