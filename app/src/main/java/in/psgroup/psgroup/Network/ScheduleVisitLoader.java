...
public class ScheduleVisitLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = ScheduleVisitLoader.class.getName();
    ...
    public ScheduleVisitLoader(Context context, String AccessToken, HashMap<String, String> input) {
        super(context);
        ...
        if (!TextUtils.isEmpty(jsonResponse)) {
            try {
                ...
                if (responsecode != 200) {
                    ...
                    response.put("data", jsonObject.getString("message"));
