...
public class RedeemNowLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = RedeemNowLoader.class.getName();
    ...
    public RedeemNowLoader(Context context, String access_token) {
        super(context);
        ...
        if (!TextUtils.isEmpty(jsonResponse)) {
            try {
                ...
                if (responsecode != 200) {
                    ...
                    response.put("video", jsonObject.getJSONArray("video").toString());
