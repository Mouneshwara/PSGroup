...
public class NotificationsLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = NotificationsLoader.class.getName();
    ...
    public NotificationsLoader(Context context, String AccessToken) {
        super(context);
