...
public class GeneralEnquiryLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = GeneralEnquiryLoader.class.getName();
    ...
    public GeneralEnquiryLoader(Context context,String AccessToken,String id) {
        super(context);
