...
public class EditPicLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = EditPicLoader.class.getName();
    ...
    public EditPicLoader(Context context, String AccessToken, HashMap<String, String> input) {
        super(context);
