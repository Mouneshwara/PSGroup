...
public class ProfileLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = ProfileLoader.class.getName();
    ...
    public ProfileLoader(Context context, String AccessToken) {
        super(context);
        ...
        if (!TextUtils.isEmpty(jsonResponse)) {
            try {
                ...
                if (responsecode != 200) {
                    ...
                    JSONObject jsonObject = new JSONObject(jsonResponse);
                    response.put("data", jsonObject.getJSONObject("data").toString());
