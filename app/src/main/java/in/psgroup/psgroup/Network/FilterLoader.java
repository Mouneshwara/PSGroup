...
public class FilterLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = FilterLoader.class.getName();
    ...
    public FilterLoader(Context context, String access_token, HashMap<String, String> input) {
        super(context);
        ...
        if (!TextUtils.isEmpty(jsonResponse)) {
            try {
                ...
                if (responsecode != 200) {
                    ...
                    JSONObject jsonObject = new JSONObject(jsonResponse);
                  response.put(context.getString(R.string.data),jsonObject.getJSONObject("data").toString());
                }
