...
public class NotificationStatusLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = NotificationStatusLoader.class.getName();
    ...
    public NotificationStatusLoader(Context context, String AccessToken, HashMap<String, String> input) {
        super(context);
    ...
    private String makeHttpRequest() throws IOException{
        ...
        Request request = new Request.Builder()
                .url(APIUrls.NOTIFICATION_READAPI)
