...
public class ProjectDetailsLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public ProjectDetailsLoader(Context context, HashMap<String, String> input,String access_token) {
        super(context);
...
//        HashMap<String,String> query_explain=new HashMap<String,String>();
    ...
    private String makeHttpRequest() throws IOException, JSONException {
        ...
        Request request = new Request.Builder()
                .url(APIUrls.PROJECTS_DETAILS_API)
