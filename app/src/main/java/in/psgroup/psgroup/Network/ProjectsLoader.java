...
public class ProjectsLoader extends AsyncTaskLoader<HashMap<String, String>> {
    private final static String TAG = ProjectsLoader.class.getName();
    ...
    public ProjectsLoader(Context context,String access_token,HashMap<String, String> input) {
        super(context);
...
//                    JSONObject jsonObject = new JSONObject(jsonResponse);
                  //  response.put("Projects", jsonObject.getJSONArray("Projects ").toString()!=null?jsonObject.getJSONArray("Projects ").toString():"");
                    JSONObject jsonObject = new JSONObject(jsonResponse);
                    response.put("projects", jsonObject.getJSONArray("projects").toString());
