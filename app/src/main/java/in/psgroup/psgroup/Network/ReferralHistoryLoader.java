...
public class ReferralHistoryLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public ReferralHistoryLoader(Context context,String access_token, HashMap<String, String> input) {
        super(context);
...
//        HashMap<String,String> query_explain=new HashMap<String,String>();
    ...
    private String makeHttpRequest() throws IOException, JSONException {
        ...
        Request request = new Request.Builder()
                .url(APIUrls.REFERRAL_HISTORY_API)
