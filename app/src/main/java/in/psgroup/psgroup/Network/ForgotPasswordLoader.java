...
/**
 * Created by Codebele on 06-Feb-19.
 */
...
public class ForgotPasswordLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public ForgotPasswordLoader(Context context, HashMap<String, String> input) {
        super(context);
...
//        HashMap<String,String> query_explain=new HashMap<String,String>();
    ...
    private String makeHttpRequest() throws IOException, JSONException {
        ...
        Request request = new Request.Builder()
                .url(APIUrls.FORGOT_PASSWORD_API)
