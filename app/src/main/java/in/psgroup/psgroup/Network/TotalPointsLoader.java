...
public class TotalPointsLoader extends AsyncTaskLoader<HashMap<String, String>> {
    ...
    public TotalPointsLoader(Context context,String access_token, HashMap<String, String> input) {
        super(context);
